...
import { faDrumstickBite, faGhost, faClover, faRainbow, faCompactDisc, faMoon, faCrown, faChampagneGlasses} from '@fortawesome/free-solid-svg-icons';
...
function MobileFloatingNav({map, isNeighbourhoodClickedRef, enableColours,  disableColours}) {
  ...
  const tileIcons = [faDrumstickBite, faGhost, faClover, faRainbow, faCompactDisc, faMoon, faCrown, faChampagneGlasses]
