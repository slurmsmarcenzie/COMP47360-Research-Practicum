    ...
    <div id="modal" className="modal-overlay" onClick={handleOutsideClick}>  
      <div className="mobile-modal-content">
        ...
        <div className="modal-scroll-content">
          <p> AfterParty is an application designed to provide insights into the impact of events on busyness in Manhattan, NYC. By analyzing taxi data supplied by the TLC (Taxi and Limousine Commission) and subway data, the tool aims to identify patterns and understand how events influence the usual urban flow.</p>
          <p> This project is developed by a team of 6 individuals as part of a Master's in Computer Science program.</p>
